...
## 3. <a name="3">Objetivo da _Sprint 11_</a>

<p align="justify">Esta <i>Sprint</i> tem como objetivo:</p>

- [US17] os posts da tela inicial dos alunos  no Back-end 
- [US20] Denunciar comentário no Back-end
- [US18] Professor ver avaliações sobre si mesmo.
- Criar da tela inicial/home do produto 
- Teste de código de qualidade estático 
- Refatorar o backlog 
- Documentação da Sprint 10 
- Refatorar pesquisa de professor/disciplina
- Burndown de riscos 
...
A Milestone da _Sprint_ 11 encontra-se neste [link](https://github.com/fga-eps-mds/2020.2-Anunbis/milestone/12)
