...
## 3. <a name="3">Objetivo da _Sprint 8_</a>

<p align="justify">Esta <i>Sprint</i> tem como objetivo:</p>

- [Bugfix] Corrigir bug de Avaliação
- Estudar  os  testes unitários 
- Refatorar Documento de Visão 
- Atualizar Documento Canvas 
- Estudar e refatorar CSS do front-end (Styled Components) 
- Documentar Sprint 7
- Documentar Identidade Visual

## 4. <a name="4">Sprint Backlog</a>

A Milestone da _Sprint_ 8 encontra-se neste [link](https://github.com/fga-eps-mds/2020.2-Anunbis/milestone/9)
