...
## 3. <a name="3">Objetivo da _Sprint 6_</a>

<p align="justify">Esta <i>Sprint</i> tem como objetivo:</p>

- US02 - Cadastro de Professor 
- US03 - Login de aluno
- US08 - Buscar um professor por maior nota geral
- US13 e US14 - Avaliação de professores (Anônimo ou não)
- Atualizar README.md
- Refatoração das Sprints anteriores
- Mudar pra arquitetura MVC no backend 
- Revisar documento de arquitetura 
- Revisar backlog do produto

## 4. <a name="4">Sprint Backlog</a>

A Milestone da _Sprint_ 6 encontra-se neste [link](https://github.com/fga-eps-mds/2020.2-Anunbis/milestone/7)
