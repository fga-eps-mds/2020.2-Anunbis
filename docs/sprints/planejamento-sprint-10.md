...
## 3. <a name="3">Objetivo da _Sprint 10_</a>

<p align="justify">Esta <i>Sprint</i> tem como objetivo:</p>

- Documentação da Sprint 9
- Integração do Time Front-End e Back-End

## 4. <a name="4">Sprint Backlog</a>

A Milestone da _Sprint_ 10 encontra-se neste [link](https://github.com/fga-eps-mds/2020.2-Anunbis/milestone/11)
